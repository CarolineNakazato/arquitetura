...
main:
	move $s0,$gp		# Ponteiro para os dados do array fonte ($gp)
	move $s1,$gp	
	addi $s1,$s1,992	# Ponteiro para os dados do array destino ($gp + 992)
	move $s2,$gp
...
dados:
	...
	move $s0,$gp		# Definimos novamente o ponteiro para os dados do array fonte ($gp)
transfere:
